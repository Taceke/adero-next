...
// const ChooseServiceDropdown = () => {
//   return (
//     <div
//       className="bg-white top-12 right-1/3 fixed drop-shadow-md rounded-2xl py-8 px-4 z-50 hidden md:group-hover:block duration-300 delay-500 ease-out"
//       id="services-menu"
//     >
//       <ul className="space-y-4">
//         <li className="hover:bg-gray-50 py-4 px-10 rounded-xl font-semibold text-gray-900 duration-300 ease-out">
//           <Link
//             href="/services/software_services/"
//             className="group flex items-center"
//           >
//             <div className="p-2 mr-4 bg-gray-50 rounded-md group-hover:bg-white">
...
// export default ChooseServiceDropdown;
